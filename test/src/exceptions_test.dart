...
void main() {
  group('ImageTransformException', () {
    test(
      'ImageTransformException.fromNative'
      ' returns EngineNotInitializedException',
      () {
    ...
    test(
      'ImageTransformException.fromNative '
      'returns UnsupportedImageFormatException',
      () {
    ...
    test(
      'ImageTransformException.fromNative '
      'returns ImageTransformerPlatformException for unknown errors',
      () {
