...
void main() {
  ...
  group('ImageTransformer', () {
    test('transform() should apply all operations and execute pipeline', () async {
    ...
    test('initialize() and terminate() interact with TransformerEngine', () async {
    ...
    test('native() factory should create instance without crashing (or catch UnsupportedError)', () {
      try {
    ...
    test('TransformerEngine.instance should invoke createTransformerEngine (or catch UnsupportedError)', () {
